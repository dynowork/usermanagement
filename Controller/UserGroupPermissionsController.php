...
class UserGroupPermissionsController extends UsermangmtAppController {

	var $uses = array('Usermangmt.UserGroupPermission','Usermangmt.UserGroup');
	var $components=array('Usermangmt.ControllerList','RequestHandler');
	/**
