...
App::uses('UsermangmtAppController', 'Usermangmt.Controller');

class UsersController extends UsermangmtAppController {
	/**
	 * This controller uses following models
	 *
	 * @var array
	 */
	public $uses = array('Usermangmt.User', 'Usermangmt.UserGroup', 'Usermangmt.LoginToken');
	/**
		...
		if ($this->request -> isPost()) {
			...
			if($this->User->LoginValidate()) {
				...
				if ($user['User']['password'] === $hashed) {
					...
					$OriginAfterLogin=$this->Session->read('Usermangmt.OriginAfterLogin');
					$this->Session->delete('Usermangmt.OriginAfterLogin');
