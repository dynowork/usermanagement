...
class User extends UsermangmtAppModel {
	 ...
	 * @var array
	 */
	var $hasMany = array('LoginToken'=>array('className'=>'Usermangmt.LoginToken','limit' =>1));
	/**
	...
	public function recaptchaValidate() {
		App::import("Vendor", "Usermangmt.recaptcha/recaptchalib");
